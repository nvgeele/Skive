...
(define is_list_intern
  (let*-values
      ([(recur-boundary) (make-graph-boundary "")]
       ...
       [(null-boundary) (make-graph-boundary "")] ;; Returns true
       ...
       [(false-boundary) (make-graph-boundary "")] ;; Returns true
       ...
       [(compound-node) (make-tagcase
                         ...
                         #(1 2 2 2 2 0 2 2 2))]
       [(boundary) (make-graph-boundary "is_list_intern" #f typedval-typedval-function-lbl)]
